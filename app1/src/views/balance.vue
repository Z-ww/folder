	...
	<div class="yu">
		<div class="header">
			...
			<div class="bot">
				<p>
					<span>当前余额</span>
					<span style="position: absolute;right: 0px;"><router-link to='/balance2'><span style="color: #3190e8;">余额说明</span></router-link></span>
				</p>
		...
		<div>
			<p style="color: #000;font-size: 12px;padding-left: 15px;">交易明详</p>
			...
			<p style="padding-left: 160px;color: #000;font-size: 14px;padding-top: 10px;">暂无明详记录</p>
		</div>
	</div>
...
// 	 	methods:{
// 	 	 btn(){
// 	 		this.$http.get('http://cangdu.org/elm/static/js/balance.37dbad39c161c27bff91.min.js')
// 	 		.then((data)=>{
// 	 			console.log(data);
// 	 		})
// 	 	}
