	...
	<div class="yu">
		<div class="header">
			...
			<div class="bot">
				<p>
					<span>当前积分</span>
					<span style="position: absolute;right: 0px;"><router-link to='/integral2'><span style="color: #3190e8;">积分说明</span></router-link></span>
				</p>
				<p style="font-size: 32px;padding-left: 6px;padding-top: 15px;">00.00<span style="font-size: 16px;"></span></p>
				<button style="background: #fe6d47;">积分兑换</button>
			</div>
		</div>
		<div>
