<template>
	<div class="yu">
		<div class="header">
			...
			<div class="bot">
				<p >
					<span style="font-size: 14px;line-height:22px;left:0">当前积分</span>
					<span>
						<router-link to='/integral2'>
							<span style="color: #3190e8; position: relative;left: 161px;">
								<i class="icon iconfont icon-shuoming" style="color: blue;"></i>
								积分说明
							</span>
						</router-link>
					</span>
				</p>
				<p style="font-size: 32px;padding-left: 6px;padding-top: 15px;">00.00<span style="font-size: 16px;"></span></p>
				<button style="background: #fe6d47;margin-bottom: 6px;">积分兑换</button>
			</div>
		</div>
		<div>
			<p style="color: #000;font-size: 12px;padding-left: 15px;">最近30天积分纪录</p>
			...
			<p style="padding-left: 100px;color: #000;font-size: 14px;padding-top: 10px;">最近30天无积分纪录</p>
			<p style="padding-left: 110px;color: #000;font-size: 10px;padding-top: 10px;">快去下单赚取大量积分吧</p>
		</div>
	</div>
