	...
	<div class="home">
		...
		<div>
			...
			<div class="z-Location">
				<router-link :to='{name:"city",query:{id:Location.id}}' style="color: #3190e8;">{{Location.name}}<span>></span></router-link>
		...
		<div class="z-box">
			...
			<div class="z-box1" v-for='i,index in home'>
				<router-link :key='index' :to='{name:"city",query:{id:i.id}}'>{{i.name}}</router-link>
			</div>
		</div>
		<div style="width: 100%;">
			<div class="z-Allcities" v-for='i,index,key in Allcities'>
				...
				<div class="z-Allcities1" v-for='a in i'>
					<router-link :key='index' :to='{name:"city",query:{id:a.id}}'>{{a.name}}</router-link>
				</div>
			</div>
		</div>
