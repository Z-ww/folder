<template>
  <div>
    <div>
      <headers :name="list_city.name" v-if='list_city.name'></headers>
    	<headers :name="list_city.name='北京'" v-else></headers>
    </div>
    <div class="msite_nav">
    ...
    <but-tom take="foodList" search="search" order="" my="mine"></but-tom>
  </div>
</template>
<script>
